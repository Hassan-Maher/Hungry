<x-app-layout>
    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto bg-white shadow-md rounded-xl p-8">
            ...
            {{-- عنوان الصفحة --}}
            <h3 class="text-2xl font-bold mb-6 text-gray-700">Update Product</h3>
            ...
            <form action="{{ route('products.update', $product->id) }}"
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                            class="w-full p-3 border rounded-lg focus:ring-indigo-300">{{ old('description', $product->description) }}</textarea>
                ...
                <div>
                    ...
                    <img src="{{ asset('storage/' . $product->img) }}" 
                        class="w-24 h-24 object-cover rounded-lg mb-3 shadow">
